  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-800 via-purple-700 to-pink-600 text-gray-50">
      ...
      <section id="projects" className="max-w-4xl mx-auto mt-12 bg-white p-8 rounded shadow-lg text-gray-800">
        ...
        <div>
            <h3 className="text-xl font-semibold text-indigo-700">Robocar Project</h3>
            <p>Robocar is a project I have built using Raspberry pi 4B and esp8266; using my own Image Recognition model to predict the direction of an Arrow.</p>
            <div className='a_div'>
